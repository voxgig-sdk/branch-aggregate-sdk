...
Aggregate API client, generated from the OpenAPI spec.

Export log-level and aggregate-level data for measuring campaign performance.

Learn more about Aggregate API at [api2.branch.io](https://api2.branch.io).

This is an unofficial SDK for the Aggregate public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.

Learn more about Voxgig SDKs at [voxgig.com/sdk](https://voxgig.com/sdk/).

Full documentation for this SDK: [https://voxgig-sdk.github.io/branch-aggregate-sdk/](https://voxgig-sdk.github.io/branch-aggregate-sdk/)
...
const client = BranchAggregateSDK.test({
  entity: {
    analytics: {
      test01: { id: 'test01', format: 'example_format', limit: 1, data_source: 'example_data_source' },
    },
  },
})
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/branch-aggregate` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-aggregate-sdk/tags) |
| Python | `voxgig-sdk-branch-aggregate` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-aggregate-sdk/tags) |
| PHP | `voxgig-sdk/branch-aggregate` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-aggregate-sdk/tags) |
| Golang | `github.com/voxgig-sdk/branch-aggregate-sdk/go` | `go get github.com/voxgig-sdk/branch-aggregate-sdk/go@latest` |
| Lua | `voxgig-sdk-branch-aggregate` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-aggregate-sdk/tags) |
| JavaScript | `@voxgig-sdk/branch-aggregate-js` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-aggregate-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/branch-aggregate-sdk/go-cli` | `go install github.com/voxgig-sdk/branch-aggregate-sdk/go-cli/cmd/branch-aggregate@latest` |
| Go MCP server | `github.com/voxgig-sdk/branch-aggregate-sdk/go-mcp` | `go get github.com/voxgig-sdk/branch-aggregate-sdk/go-mcp@latest` |
...
```bash
cd go-mcp && go build -o branch-aggregate-mcp .
```
...
```json
{
  "mcpServers": {
    "branch-aggregate": {
      "command": "/abs/path/to/branch-aggregate-mcp"
    }
  }
}
```
...
```go
import sdk "github.com/voxgig-sdk/branch-aggregate-sdk/go"
...
Generated from the Aggregate API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
