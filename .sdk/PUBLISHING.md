...
|---|---|---|
| `js/` | @voxgig-sdk/branch-aggregate-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branch-aggregate | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branch-aggregate-js \
      --repository voxgig-sdk/branch-aggregate-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branch-aggregate-js` shows it, and
`npm trust revoke @voxgig-sdk/branch-aggregate-js --id=<id>` removes it.
