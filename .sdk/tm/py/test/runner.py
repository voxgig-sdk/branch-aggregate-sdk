...
class BranchAggregateTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BranchAggregateTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = BranchAggregateTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = BranchAggregateTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
