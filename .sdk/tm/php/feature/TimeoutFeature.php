...
// BranchAggregate SDK timeout feature
...
class BranchAggregateTimeoutFeature extends BranchAggregateBaseFeature
{
    ...
    private function _with_timeout(BranchAggregateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchAggregateContext $_ctx, float $ms): void
    {
        $client = $this->client;
