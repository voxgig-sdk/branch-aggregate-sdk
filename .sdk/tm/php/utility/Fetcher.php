...
// BranchAggregate SDK utility: fetcher

class BranchAggregateFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchAggregateSDK/1.0)';
    ...
    public static function call(BranchAggregateContext $ctx, string $fullurl, array $fetchdef): array
    {
