...
// BranchAggregate SDK utility: make_options

class BranchAggregateMakeOptions
{
    ...
    public static function call(BranchAggregateContext $ctx): array
    {
        ...
        //
        // `BranchAggregateSchema::optspec()` is built from the model:
        ...
        $optspec = BranchAggregateSchema::optspec();
