...
// BranchAggregate SDK pipeline test
//
...
{
    private static function utility(): BranchAggregateUtility
    {
        return new BranchAggregateUtility();
    }
    ...
    private static function ctx(array $over = []): BranchAggregateContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BranchAggregateContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BranchAggregateOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BranchAggregateError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BranchAggregateOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BranchAggregateMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BranchAggregateOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BranchAggregateMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BranchAggregateOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BranchAggregateMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchAggregateSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BranchAggregateMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BranchAggregateResponse([]),
            'result' => new BranchAggregateResult([]),
        ]);
        [, $err] = BranchAggregateMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BranchAggregateSpec([]),
            'response' => null,
            'result' => new BranchAggregateResult([]),
        ]);
        [, $err] = BranchAggregateMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BranchAggregateSpec(['step' => 's']),
            'response' => new BranchAggregateResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BranchAggregateResult([]),
        ]);
        [, $err] = BranchAggregateMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchAggregateSpec(['step' => 's']),
            'response' => new BranchAggregateResponse(self::resp(200, ['v' => 1])),
            'result' => new BranchAggregateResult([]),
        ]);
        [, $err] = BranchAggregateMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BranchAggregateSpec(['step' => 's']),
            'response' => new BranchAggregateResponse(self::resp(200, ['v' => 2])),
            'result' => new BranchAggregateResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BranchAggregateMakeResponse::call($ctx);
    ...
    {
        $preset = new BranchAggregateResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BranchAggregateSpec([]),
            'response' => new BranchAggregateResponse([]),
            'result' => new BranchAggregateResult([]),
        ...
        [$got, $err] = BranchAggregateMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BranchAggregateResult([])]);
        [, $err] = BranchAggregateMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BranchAggregateSpec([]), 'result' => null]);
        [, $err] = BranchAggregateMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchAggregateSpec(['step' => 's']),
            'result' => new BranchAggregateResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BranchAggregateOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchAggregateMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BranchAggregateSpec(['step' => 's']),
            'result' => new BranchAggregateResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BranchAggregateOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BranchAggregateMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BranchAggregateResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BranchAggregateSpec([]),
            'result' => new BranchAggregateResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BranchAggregateMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchAggregateMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BranchAggregateError('boom', 'boom');
        $utility->fetcher = function (BranchAggregateContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchAggregateSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BranchAggregateMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BranchAggregateContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BranchAggregateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BranchAggregateResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BranchAggregateMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BranchAggregateContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BranchAggregateSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BranchAggregateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BranchAggregateResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BranchAggregateSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BranchAggregateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BranchAggregateMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BranchAggregateMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BranchAggregateResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BranchAggregateDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BranchAggregateResult(['ok' => false])]);
        $this->expectException(BranchAggregateError::class);
        BranchAggregateDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BranchAggregateResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BranchAggregateMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BranchAggregateMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BranchAggregateBaseFeature();
        $b = new BranchAggregateBaseFeature();
        BranchAggregateFeatureAdd::call($ctx, $a);
        BranchAggregateFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BranchAggregateBaseFeature
    {
        $f = new BranchAggregateBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BranchAggregateFeatureAdd::call($ctx, self::named_feature('a'));
        BranchAggregateFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BranchAggregateFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BranchAggregateFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BranchAggregateFeatureAdd::call($ctx, $replace);
        ...
        BranchAggregateFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BranchAggregateContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BranchAggregateSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BranchAggregatePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BranchAggregatePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BranchAggregateResponse(['headers' => null]),
            'result' => new BranchAggregateResult([]),
        ]);
        BranchAggregateResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BranchAggregateResultBody::call($ctx);
