...
local function make_error_util(ctx, err)
  ...
  local msg = "BranchAggregateSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = BranchAggregateError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == BranchAggregateError then
