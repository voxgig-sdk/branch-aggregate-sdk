...
function runner.env_override(m)
  local live = runner.getenv("BRANCH_AGGREGATE_TEST_LIVE")
  local override = runner.getenv("BRANCH_AGGREGATE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BRANCH_AGGREGATE_TEST_EXPLAIN")
