...
class BranchAggregateTestRunner
{
    ...
    {
        $live = self::getenv('BRANCH_AGGREGATE_TEST_LIVE');
        $override = self::getenv('BRANCH_AGGREGATE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BRANCH_AGGREGATE_TEST_EXPLAIN');
...
class_alias('BranchAggregateTestRunner', 'Runner');
class_alias('BranchAggregateHelpers', 'Helpers');
