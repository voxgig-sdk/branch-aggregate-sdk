...
// BranchAggregate SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BranchAggregateOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BranchAggregateOmni::structfix($now, Struct::undef()))
                        !== json_encode(BranchAggregateOmni::structfix($val, Struct::undef()))) {
