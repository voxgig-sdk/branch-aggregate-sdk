...
// BranchAggregate SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchAggregateSDK::test)
...
{
    private const SDK_CLASS = 'BranchAggregateSDK';
    ...
    private const SDK_BASE = 'branchaggregate_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../branchaggregate_sdk.php';
