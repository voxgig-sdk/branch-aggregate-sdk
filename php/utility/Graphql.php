...
// BranchAggregate SDK utility: graphql
//
...
class BranchAggregateGraphql
{
    ...
    // equivalent.
    public static function body(BranchAggregateContext $ctx): mixed
    {
    ...
    public static function errors(BranchAggregateContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
