...
// BranchAggregate SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BranchAggregateMakeRequest
{
    public static function call(BranchAggregateContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BranchAggregateResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BranchAggregateResponse($fetched);
        } else {
