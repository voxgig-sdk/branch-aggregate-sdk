...
// BranchAggregate SDK utility: result_basic

class BranchAggregateResultBasic
{
    public static function call(BranchAggregateContext $ctx): ?BranchAggregateResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BranchAggregateError) ? $result->err->msg : (string)$result->err;
