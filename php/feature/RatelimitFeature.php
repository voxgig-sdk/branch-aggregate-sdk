...
// BranchAggregate SDK ratelimit feature
...
class BranchAggregateRatelimitFeature extends BranchAggregateBaseFeature
{
    ...
    private function _acquire(BranchAggregateContext $ctx): void
    {
    ...
    private function _track(BranchAggregateContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
