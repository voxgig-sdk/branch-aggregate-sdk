...
// BranchAggregate SDK paging feature
...
class BranchAggregatePagingFeature extends BranchAggregateBaseFeature
{
    ...
    private function _graphql_pre_request(BranchAggregateContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchAggregateContext $ctx): bool
    {
