...
// BranchAggregate SDK utility type

class BranchAggregateUtility
{
    ...
    public static function copy(BranchAggregateUtility $src): BranchAggregateUtility
    {
        $u = new BranchAggregateUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
