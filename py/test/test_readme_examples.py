# BranchAggregate SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchAggregateSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchAggregateSDK(...) and BranchAggregateSDK.test(...) become
#      BranchAggregateSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchaggregate_sdk"
_SDK_CLASS = "BranchAggregateSDK"
