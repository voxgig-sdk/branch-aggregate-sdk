...
from branchaggregate_sdk.core.control import BranchAggregateControl
...
from branchaggregate_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchAggregateContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BranchAggregateControl()
        ...
        if isinstance(sp, BranchAggregateSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BranchAggregateResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchAggregateResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BranchAggregateOperation({})
    ...
    def make_error(self, code, msg):
        return BranchAggregateError(code, msg, self)
