...
from branchaggregate_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from branchaggregate_sdk.utility import register

# Load features
from branchaggregate_sdk.feature.base_feature import BranchAggregateBaseFeature
from branchaggregate_sdk.features import _has_feature, _make_feature
...
class BranchAggregateSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchAggregateUtility()
        self._utility = utility

        from branchaggregate_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchAggregateUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchAggregateSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from branchaggregate_sdk.entity.analytics_entity import AnalyticsEntity
        return AnalyticsEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BranchAggregateSDK":
        if sdkopts is None:
            sdkopts = {}
