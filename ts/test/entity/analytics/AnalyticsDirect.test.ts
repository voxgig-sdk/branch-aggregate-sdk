...
import { BranchAggregateSDK } from '../../..'
...
describe('AnalyticsDirect', async () => {
  ...
  afterEach(liveDelay('BRANCH_AGGREGATE_TEST_LIVE'))

  test('direct-exists', async () => {
    const sdk = new BranchAggregateSDK({
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BRANCH_AGGREGATE_TEST_ANALYTICS_ENTID']
