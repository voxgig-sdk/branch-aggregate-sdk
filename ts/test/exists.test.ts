...
describe('exists', async () => {
  ...
  //
  // BranchAggregateSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    const testsdk = BranchAggregateSDK.test()
    equal(testsdk instanceof BranchAggregateSDK, true,
      'BranchAggregateSDK.test() must return a client synchronously')
  })
