...
(0, node_test_1.describe)('exists', async () => {
    ...
    (0, node_test_1.test)('test-mode', () => {
        const testsdk = __1.BranchAggregateSDK.test();
        (0, node_assert_1.equal)(testsdk instanceof __1.BranchAggregateSDK, true, 'BranchAggregateSDK.test() must return a client synchronously');
    });
});
