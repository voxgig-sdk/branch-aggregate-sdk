...
function envOverride(m) {
    if ('TRUE' === process.env.BRANCH_AGGREGATE_TEST_LIVE ||
        'TRUE' === process.env.BRANCH_AGGREGATE_TEST_OVERRIDE) {
    ...
    m.BRANCH_AGGREGATE_TEST_EXPLAIN = process.env.BRANCH_AGGREGATE_TEST_EXPLAIN || m.BRANCH_AGGREGATE_TEST_EXPLAIN;
    return m;
}
