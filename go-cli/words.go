...
func registerSDKWords(r *eng.Registry, client *sdk.BranchAggregateSDK) {
...
func runOp(client *sdk.BranchAggregateSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
