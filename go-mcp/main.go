// Command BranchAggregate-mcp is an MCP server exposing the BranchAggregate
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BranchAggregate_list  — list records of an entity
//	BranchAggregate_load  — load a single record of an entity
//
