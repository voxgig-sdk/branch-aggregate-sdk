...
func registerTools(server *mcp.Server, client *sdk.BranchAggregateSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-aggregate_list",
		Description: "List records from BranchAggregate. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-aggregate_load",
		Description: "Load a single record from BranchAggregate. " +
...
func runOp(client *sdk.BranchAggregateSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchAggregateSDK, name string) (sdk.BranchAggregateEntity, error) {
