...
| [Analytics](docs/api/analytics.html) | `load` | `GET /analytics/{job_id}` | Required |
...
- `branch-aggregate_list`: List records for an entity. No active entity supports this operation.
- `branch-aggregate_load`: Load one record for an entity. Supported entities: `analytics`.
